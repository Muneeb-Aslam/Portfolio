...
function About() {
  return (
    <section className="about">
      ...
      <main>
        <div className="mern">Full Stack Development</div>
        <ul className="description">
          <li className="points">✨Building responsive websites using React-Redux.js | HTML/CSS | TailwindCSS</li>
          <li className="points">✨Creating Single page rendering applications using Redux</li>
